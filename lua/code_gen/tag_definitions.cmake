...
add_custom_command(
    ...
    COMMAND ${LUA_COMMNAD} ${TAG_FIX_DEPENDENCIES_FUNCTION_GENERATOR_SCRIPT} ${TAG_FIX_DEPENDENCIES_FUNCTION_CPP} ${TAG_DEFINITION_FILES}
    WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
    COMMENT "Generating tag fix dependencies functions..."
    DEPENDS ${TAG_FIX_DEPENDENCIES_FUNCTION_GENERATOR_SCRIPT} ${TAG_DEFINITION_FILES}
)
...
add_custom_command(
    ...
    WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
    COMMENT "Generating tag Lua metatables..."
