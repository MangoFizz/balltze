...
add_custom_command(
    ...
    DEPENDS ${TAG_DEFINITION_PARSER_SCRIPT} ${TAG_LUA_METATABLE_FUNCTION_GENERATOR_SCRIPT} ${TAG_DEFINITION_FILES}
)
...
add_custom_command(
    OUTPUT ${TAG_LUA_ANNOTATIONS}
    COMMAND ${LUA_COMMNAD} ${TAG_LUA_ANNOTATIONS_GENERATOR_SCRIPT} ${TAG_LUA_ANNOTATIONS} ${TAG_DEFINITION_FILES}
    WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
