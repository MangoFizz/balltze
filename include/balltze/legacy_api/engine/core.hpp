...
#ifndef BALLTZE_LEGACY_API__ENGINE__CORE_HPP
#define BALLTZE_LEGACY_API__ENGINE__CORE_HPP
...
namespace Balltze::LegacyApi::Engine {
    ...
    #define CONSOLE_COLOR_ERROR Balltze::LegacyApi::Engine::ColorARGB{1.0, 0.0, 0.0, 1.0}
