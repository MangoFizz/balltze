...
#ifndef BALLTZE_LEGACY_API__ENGINE__WIDGET_HPP
#define BALLTZE_LEGACY_API__ENGINE__WIDGET_HPP
...
namespace Balltze::LegacyApi::Engine {
    ...
    struct Widget {
        ...
        /** Widget position */
        LegacyApi::Engine::Point2DInt position;
     ...
     */
    BALLTZE_API Resolution get_bitmap_sprite_resolution(LegacyApi::Engine::TagDefinitions::Bitmap *bitmap, std::size_t sequence_index, std::size_t sprite_index = 0);
     ...
     * @throws std::runtime_error   If the sprite index is invalid.
     */
    BALLTZE_API void draw_hud_message_sprite(LegacyApi::Engine::TagDefinitions::Bitmap *bitmap, std::size_t sequence_index, std::size_t sprite_index, Point2DInt position, ColorARGBInt color);
     ...
     */
    BALLTZE_API std::wstring get_button_name(LegacyApi::Engine::InputDevice input_device, std::size_t button_index);
