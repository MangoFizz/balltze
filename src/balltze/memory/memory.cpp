...
namespace Balltze::Memory {
    ...
    static void find_engine_signatures() {
        ...
        FIND_SIGNATURE("d3d9_call_begin_scene", 0x0, 0, {0xFF, 0x91, 0xA4, 0x00, 0x00, 0x00, 0x85, 0xC0, 0x7D, 0x07, 0x32, 0xC0});
        ...
        FIND_SIGNATURE("tag_data_read_done", 0x0, 0, {0xE9, -1, -1, -1, -1, 0x90, 0x8B, 0x07, 0xA3, -1, -1, -1, -1, 0xA0, -1, -1, -1, -1, 0x84, 0xC0});
        ...
        FIND_SIGNATURE("loading_screen_render_function", 0x0, 0, {0xA1, -1, -1, -1, -1, 0x81, 0xEC, 0x18, 0x04, 0x00, 0x00, 0x57, 0x33, 0xFF, 0x3B, 0xC7});
        FIND_SIGNATURE("loading_screen_background_render_call", 0x0, 0, {-1, -1, -1, -1, -1, 0x83, 0xC4, 0x0C, 0x55, 0x6A, 0x02, 0x6A, 0xFF, 0x8D, 0x44, 0x24, 0x24});

        FIND_SIGNATURE("set_video_mode", 0x0, 0, {0xE9, -1, -1, -1, -1, 0x90, 0x85, 0xC0, 0x7D, 0x29, 0x46});
        FIND_SIGNATURE("load_bitmap_function", 0x0, 0, {0x83, 0xEC, 0x08, 0x53, 0x55, 0x56, 0x8B, 0xF0, 0x8A, 0x46, 0x0E, 0x33, 0xDB});

        FIND_SIGNATURE("master_volume", 0x1, 0, {0xBE, -1, -1, -1, -1, 0x8D, 0x7C, 0x24, 0x10, 0xF3, 0xA5, 0x8B, 0x42, 0x34});

        FIND_SIGNATURE("render_hud_function_call", 0x5, 0, {0xE8, -1, -1, -1, -1, 0xE8, -1, -1, -1, -1, 0xA1, 0x24, 0xCD, 0x68, 0x00, 0x85, 0xC0, 0x5E});
        FIND_SIGNATURE("render_hud_function", 0x0, 0, {0x8b, 0x0d, 0x68, 0xe4, 0x75, 0x00, 0x66, 0x83, 0xf9, 0xff, 0x53, 0x57, 0x74, 0x15, 0x66, 0x83, 0xf9, 0x01, 0x7d, 0x0f, 0x8b, 0x15, 0x18, 0x59, 0x81, 0x00});
        FIND_SIGNATURE("render_ui_function_call", 0xC, 0, {0xE8, -1, -1, -1, -1, 0xE8, -1, -1, -1, -1, 0x8B, 0xC5, 0xE8, -1, -1, -1, -1, 0x66, 0x83, 0x3D, 0x82, 0xC5, 0x75, 0x00, 0xFF});
        FIND_SIGNATURE("render_ui_function", 0x0, 0, {0x33, 0xc9, 0x83, 0xec, 0x14, 0x66, 0x3d, 0xff, 0xff, 0x0f, 0x94, 0xc1, 0x53, 0x33, 0xdb, 0x49, 0x23, 0xc8, 0x66, 0x89, 0x0d, 0xf0, 0x53, 0x81, 0x00});
        FIND_SIGNATURE("render_post_carnage_report_call", 0x2, 0, {0x74, 0x07, 0xE8, -1, -1, -1, -1, 0xEB, 0x19, 0xE8, -1, -1, -1, -1, 0xE8, -1, -1, -1, -1, 0xE8, -1, -1, -1, -1, 0xE8, -1, -1, -1, -1, 0xE8, -1, -1, -1, -1, 0x66, 0x39, 0x35, -1, -1, -1, -1});
        FIND_SIGNATURE("render_post_carnage_report_function", 0x0, 0, {0xa1, -1, -1, -1, -1, 0x83, 0xec, 0x08, 0x56, 0x33, 0xf6, 0x3b, 0xc6, 0x74, 0x31, 0x83, 0x3d, -1, -1, -1, -1, 0x01});
        FIND_SIGNATURE("render_widget_background_function_call", 0x0, 0, {/**0xE8*/ -1, -1, -1, -1, -1, 0x83, 0xC4, 0x04, 0x5F, 0x5D, 0x5B, 0x5E, 0x81, 0xC4, 0x30, 0x01, 0x00, 0x00, 0xC3});
        FIND_SIGNATURE("render_hud_element_bitmap_function_call", 0x0, 0, {/**0xE8*/ -1, -1, -1, -1, -1, 0x83, 0xC4, 0x04, 0x5F, 0x5D, 0x5B, 0x81, 0xC4, 0x10, 0x01, 0x00, 0x00, 0xC3});
        FIND_SIGNATURE("render_navpoint_function_call", 0x0, 0, {/**0xE8*/ -1, -1, -1, -1, -1, 0x83, 0xC4, 0x10, 0x8B, 0x54, 0x24, -1, 0x42, 0x83, -1, 0x20, 0x81, -1, -1, -1, -1, -1, 0x89});

        FIND_SIGNATURE("d3d9_render_targets", 0x2, 0, {0x8b, 0xb8, 0x10, 0x8a, 0x63, 0x00, 0x89, 0x4c, 0x24, 0x28, 0x89, 0x44, 0x24, 0x1c, 0x89, 0x7c, 0x24, 0x20});

        FIND_SIGNATURE("read_region_permutation_function_reserve_local_vars_space", 0x0, 0, {0x83, 0xec, 0x4c, 0x53, 0x25, 0xff, 0xff, 0x00, 0x00, 0x57, 0x8b, 0xf9, 0x8b, 0x0d, -1, -1, -1, -1, 0x8b, 0x51, 0x34});
        FIND_SIGNATURE("read_region_permutation_function_free_local_vars_space", 0x6, 0, {0x8a, 0x44, 0x24, 0x13, 0x5e, 0x5d, 0x5f, 0x5b, 0x83, 0xc4, 0x4c, 0xc3});
        FIND_SIGNATURE("read_region_permutation_function_param_1_read_1", 0x0, 0, {0x8b, 0x4c, 0x24, 0x58, 0x8d, 0x04, 0x40, 0x8b, 0x44, 0x82, 0x08, 0x8b, 0x91, 0xc4, 0x00, 0x00, 0x00, 0x33, 0xdb});
        FIND_SIGNATURE("read_region_permutation_function_param_1_read_2", 0x0, 0, {0x8b, 0x4c, 0x24, 0x60, 0x40, 0x0f, 0xbf, 0xd8, 0x89, 0x44, 0x24, 0x18});

        FIND_SIGNATURE("find_console_command_entry_function_command_list_address", 0x3, 0, {0x8b, 0x14, 0x8d, -1, -1, -1, -1, 0x8b, 0x42, 0x04, 0x53, 0x50, 0xe8, 0xf5, 0x7a, 0x14, 0x00});
        FIND_SIGNATURE("find_console_command_entry_function_command_list_count", 0x3, 0, {0x66, 0x81, 0xfe, 0x11, 0x02, 0x7c, 0xdd, 0x5f, 0x5e, 0x66, 0x0d, 0xff, 0xff});
