...
namespace Balltze::Memory {
    ...
    static bool find_core_signatures() {
        ...
        /** Multiplayer */
        FIND_SIGNATURE("chat_out", 0x0, {0x83, 0xEC, 0x10, 0x8A, 0x4C, 0x24, 0x14, 0x55, 0x6A, 0x00, 0x6A, 0x01, 0x6A, 0x00, 0x88, 0x4C, 0x24, 0x18});
        ...
        /** Network */
        FIND_SIGNATURE("mdp_decode_stateless_iterated_function", 0x0, {0x57, 0x8B, 0x38, 0x51, 0x83, 0xC0, 0x04, 0x6A, 0x00, 0x50, 0xE8, -1, -1, -1, -1});
        FIND_SIGNATURE("mdp_encode_stateless_iterated_function", 0x0, {0x81, 0xEC, 0xA4, 0x00, 0x00, 0x00, 0x53, 0x55, 0x8B, 0xAC, 0x24, 0xBC, 0x00, 0x00, 0x00});
        FIND_SIGNATURE("mdp_discard_iteration_body_function", 0x0, {0x81, 0xEC, 0x00, 0x08, 0x00, 0x00, 0x56, 0x57, 0x8B, 0x38, 0x8B, 0x37});
        FIND_SIGNATURE("net_send_message_to_all_function", 0x0, {0x83, 0xEC, 0x08, 0x53, 0x55, 0x8B, 0x6C, 0x24, 0x28, 0x56, 0x8B, 0xF1, 0x57, 0x8B, 0xD8});
        FIND_SIGNATURE("net_send_message_to_player_function", 0x0, {0x51, 0x53, 0x57, 0x8B, 0xF8, 0x32, 0xC0, 0x33, 0xC9});
        FIND_SIGNATURE("net_send_message_socket_ready_function", 0x0, {-1, -1, -1, -1, 0x3B, 0xC3, 0x74, 0x1A, 0x83, 0xC0, 0x08, 0x3B, 0xC3, 0x74, 0x13});
    ...
    static bool find_client_signatures() {
        ...
        /** Network */
        FIND_SIGNATURE("socket_recv_from_call", 0x0, {0xE8, -1, -1, -1, -1, 0x8B, 0xF0, 0x83, 0xFE, 0xFF, 0x75, 0x4B, 0xE8, -1, -1, -1, -1, 0x3D, 0x46, 0x27, 0x00, 0x00});
    ...
    static bool find_dedicated_server_signatures() {
        /** Network */
        FIND_SIGNATURE("socket_recv_from_call", 0x0, {0xE8, -1, -1, -1, -1, -1, -1, -1, -1, -1, 0x75, 0x4B, 0xE8, -1, -1, -1, -1, 0x3D, 0x46, 0x27, 0x00, 0x00});
