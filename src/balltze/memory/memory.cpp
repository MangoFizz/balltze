...
namespace Balltze::Memory {
    ...
    static bool find_client_signatures() {
        ...
        FIND_SIGNATURE("hud_draw_meter_bitmap_call", 0xA, { 0xC6, 0x44, 0x24, 0x78, 0x00, 0xC6, 0x44, 0x24, 0x79, 0x01, 0xE8, -1, -1, -1, -1, 0x83, 0xC4, 0x20, 0x5F, 0x5D, 0x5B, 0x83, 0xC4, 0x58 });
        FIND_SIGNATURE("rasterizer_draw_screen_quad_bitmap_meter", 0x0, { 0xA1, -1, -1, -1, -1, 0x8B, 0x10, 0x6A, 0x00, 0x50, 0xFF, 0x92, 0xAC, 0x01, 0x00, 0x00, 0xA1, -1, -1, -1, -1 });
        FIND_SIGNATURE("rasterizer_draw_screen_quad_bitmap_meter_return", 0x0, { 0x0F, 0xB6, 0x0D, -1, -1, -1, -1, 0xA1, -1, -1, -1, -1, 0x8B, 0x10, 0x51, 0x50, 0xFF, 0x92, 0x34, 0x01, 0x00, 0x00, 0x5F, 0x5D });
        ...
        FIND_SIGNATURE("multiplayer_screen_extended_description_pic_index_1", 0x0, { 0x8B, 0x40, 0x34, 0x66, 0x89, 0x78, 0x58, 0xEB, 0x0C, 0x8B, 0x42, 0x4C, 0x8B, 0x40, 0x34 }); 
        ...
        FIND_SIGNATURE("rasterizer_shader_switch_cmp", 0x0, { 0x0f, 0x87, 0x14, 0x12, 0x00, 0x00, 0xff, 0x24, 0x85, -1, -1, -1, -1, 0x0f, 0xbf, 0x43, 0x14, 0x48 });
        FIND_SIGNATURE("rasterizer_shader_switch_entry", 0x0, { 0xff, 0x24, 0x85, -1, -1, -1, -1, 0x0f, 0xbf, 0x43, 0x14, 0x48, 0x0f, 0x85, 0x02, 0x12, 0x00, 0x00 });
        FIND_SIGNATURE("rasterider_shader_switch_default_case", 0x0, { 0x8b, 0x44, 0x24, 0x34, 0x40, 0x66, 0x3d, 0x02, 0x00, 0x89, 0x44, 0x24, 0x34, 0x0f, 0x8c, 0x44, 0xed, 0xff, 0xff });
