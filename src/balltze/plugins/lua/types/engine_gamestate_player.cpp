...
namespace Balltze::Plugins::Lua {
    ...
    void lua_define_player_struct(lua_State *state) noexcept {
        ...
        luacs_nested_field(state, EnginePlayer, EngineTickCount32, respawn_time, 0);
        luacs_nested_field(state, EnginePlayer, EngineTickCount32, respawn_time_growth, 0);
        ...
        luacs_nested_field(state, EnginePlayer, EngineTickCount32, last_fire_time, 0);
        ...
        luacs_nested_field(state, EnginePlayer, EngineTickCount32, target_time, 0);
        luacs_nested_field(state, EnginePlayer, EngineTickCount32, last_death_time, 0);
        ...
        luacs_nested_field(state, EnginePlayer, EngineTickCount32, telefrag_timer, 0);
        luacs_nested_field(state, EnginePlayer, EngineTickCount32, quit_time, 0);
        ...
        luacs_nested_field(state, EnginePlayer, EngineTickCount32, team_kill_ticks_since_last, 0);
