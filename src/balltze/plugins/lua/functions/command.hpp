...
namespace Balltze::Plugins::Lua {
    class Command : public Balltze::Command {
    public:
        CommandResult call(std::size_t arg_count, const char **args) const noexcept;
        
        void register_command(LuaPlugin *plugin);
        
        Command(std::string name, std::string category, std::string help, std::optional<std::string> params_help, bool autosave, std::size_t min_args, std::size_t max_args, bool can_call_from_console = true, bool is_public = false) :
